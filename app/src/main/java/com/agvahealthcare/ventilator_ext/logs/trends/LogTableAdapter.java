...
public class LogTableAdapter extends TableDataAdapter<DataTableModel> {

    private Context context;
    private List<DataTableModel> dataList;

    public LogTableAdapter(Context context, List<DataTableModel> dataList) {
    ...
    public View getCellView(int rowIndex, int columnIndex, ViewGroup parentView) {
        final DataTableModel modal = dataList.get(rowIndex);
        ...
        switch (columnIndex) {
            ...
            case 7:
                renderedView = renderCell(String.format("%.1f", modal.getIeratio()));
                break;

package com.agvahealthcare.ventilator_ext.utility.number_picker;
...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray attributes = context.obtainStyledAttributes(attrs,
                com.shawnlin.numberpicker.R.styleable.NumberPicker, defStyle, 0);

        final Drawable selectionDivider = attributes.getDrawable(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_divider);
        if (selectionDivider != null) {
            ...
            mDividerColor = attributes.getColor(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerColor,
                    mDividerColor);
        ...
        mDividerDistance = attributes.getDimensionPixelSize(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerDistance, defDividerDistance);
        mDividerLength = attributes.getDimensionPixelSize(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerLength, 0);
        mDividerThickness = attributes.getDimensionPixelSize(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerThickness, defDividerThickness);
        mDividerType = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerType, SIDE_LINES);

        mOrder = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_order, ASCENDING);
        mOrientation = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_orientation, VERTICAL);

        final float width = attributes.getDimensionPixelSize(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_width,
                SIZE_UNSPECIFIED);
        final float height = attributes.getDimensionPixelSize(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_height,
                SIZE_UNSPECIFIED);
        ...
        mValue = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_value, mValue);
        mMaxValue = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_max, mMaxValue);
        mMinValue = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_min, mMinValue);

        mSelectedTextAlign = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTextAlign,
                mSelectedTextAlign);
        mSelectedTextColor = attributes.getColor(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTextColor,
                mSelectedTextColor);
        mSelectedTextSize = attributes.getDimension(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTextSize,
                spToPx(mSelectedTextSize));
        mSelectedTextStrikeThru = attributes.getBoolean(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTextStrikeThru, mSelectedTextStrikeThru);
        mSelectedTextUnderline = attributes.getBoolean(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTextUnderline, mSelectedTextUnderline);
        mSelectedTypeface = Typeface.create(attributes.getString(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTypeface), Typeface.NORMAL);
        mTextAlign = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_textAlign, mTextAlign);
        mTextColor = attributes.getColor(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_textColor, mTextColor);
        mTextSize = attributes.getDimension(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_textSize,
                spToPx(mTextSize));
        mTextStrikeThru = attributes.getBoolean(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_textStrikeThru, mTextStrikeThru);
        mTextUnderline = attributes.getBoolean(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_textUnderline, mTextUnderline);
        mTypeface = Typeface.create(attributes.getString(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_typeface),
                Typeface.NORMAL);
        mFormatter = stringToFormatter(attributes.getString(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_formatter));
        mFadingEdgeEnabled = attributes.getBoolean(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_fadingEdgeEnabled,
                mFadingEdgeEnabled);
        mFadingEdgeStrength = attributes.getFloat(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_fadingEdgeStrength,
                mFadingEdgeStrength);
        mScrollerEnabled = attributes.getBoolean(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_scrollerEnabled,
                mScrollerEnabled);
        mWheelItemCount = attributes.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_wheelItemCount,
                mWheelItemCount);
        mLineSpacingMultiplier = attributes.getFloat(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_lineSpacingMultiplier, mLineSpacingMultiplier);
        mMaxFlingVelocityCoefficient = attributes.getInt(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_maxFlingVelocityCoefficient,
                mMaxFlingVelocityCoefficient);
        mHideWheelUntilFocused = attributes.getBoolean(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_hideWheelUntilFocused, false);
        mAccessibilityDescriptionEnabled = attributes.getBoolean(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_accessibilityDescriptionEnabled, true);
        mItemSpacing = attributes.getDimensionPixelSize(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_itemSpacing, 0);
        ...
        inflater.inflate(com.shawnlin.numberpicker.R.layout.number_picker_material, this, true);
        ...
        mWrapSelectorWheel = attributes.getBoolean(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_wrapSelectorWheel,
                mWrapSelectorWheel);
